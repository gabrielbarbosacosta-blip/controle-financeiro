(function(){
  ...
  function reconcileExpense(expense){
    ...
    for(let n=first;n<=last;n++){
      const ym=addMonth(expense.firstMonth,n-first),old=byNumber.get(n),denom=expense.openEnded?'∞':String(last),date=safeDate(ym,expense.dueDay),amount=Number(expense.installmentAmount)||0;
