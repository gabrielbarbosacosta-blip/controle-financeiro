(function(){
  ...
  async function openSharedRecurring(goalId){
    ...
    if(info){
      ...
      else if(approval==='accepted'&&existing?.enabled)info.innerHTML='<strong>Recorrência confirmada e ativa.</strong> As Despesas recorrentes dos participantes e as Receitas de reembolso do pagador foram registradas. Os lançamentos mensais são gerenciados por esses planos.';
