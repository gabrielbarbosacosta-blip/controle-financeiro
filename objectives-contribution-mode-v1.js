(function(){
  ...
  async function openSharedRecurring(goalId){
    ...
    const createAnother=document.getElementById('goalSharedRecurringCreateAnother');
    if(createAnother)createAnother.style.display=existing?'inline-flex':'none';
