(function(){
  ...
  function injectStyles(){
    ...
    const s=document.createElement('style');s.id=STYLE_ID;s.textContent=`
      ...
      .goal-card{border:1px solid var(--line);border-radius:16px;background:#0f172a;overflow:hidden;display:grid;grid-template-columns:minmax(0,1fr) 168px;align-items:stretch}
      .goal-card-main{min-width:0}
      .goal-contributor-summary{min-width:0;border-left:1px solid var(--line);background:rgba(11,20,36,.5);padding:13px 11px;display:flex;flex-direction:column;gap:8px}
      .goal-contributor-summary-title{font-size:9px;font-weight:850;letter-spacing:.08em;text-transform:uppercase;color:#8293a8}
      .goal-contributor-summary-month{font-size:9px;color:#6f8298;margin-top:-3px}
      ...
      .goal-contributor-value.month strong{color:#91d6b9}
      .goal-contributor-summary-empty{font-size:9px;color:#71839a;line-height:1.45;padding-top:2px}
      @media(max-width:900px){.goal-card{grid-template-columns:1fr}.goal-contributor-summary{border-left:0;border-top:1px solid var(--line);padding:11px 14px}.goal-contributor-list{grid-template-columns:repeat(auto-fit,minmax(135px,1fr));gap:8px}.goal-contributor-row{border-top:0;padding:6px 0}}
