(function(){
  ...
  function ensureSharingPage(){
    ...
    section.innerHTML=`<div class="shared-page-grid"><div class="card kpi"><div class="label">A receber</div><div class="value positive" id="sharedToReceive">—</div><div class="hint">Reembolsos pendentes</div></div><div class="card kpi"><div class="label">A pagar</div><div class="value negative" id="sharedToPay">—</div><div class="hint">Sua parte em despesas de terceiros</div></div><div class="card kpi"><div class="label">Saldo líquido</div><div class="value" id="sharedNet">—</div><div class="hint">A receber menos a pagar</div></div></div><div class="card" style="margin-bottom:14px"><div class="section-head"><div><h3>Convites pendentes</h3><div class="muted">Confirme antes de a despesa entrar nos seus lançamentos.</div></div><button type="button" class="btn small" id="sharedRefresh">Atualizar</button></div><div class="shared-list" id="sharedPendingList"></div></div><div class="card" style="margin-bottom:14px"><div class="section-head"><div><h3>Acertos por pessoa</h3><div class="muted">Valores pendentes de reembolso e compensação líquida.</div></div></div><div id="sharedBalances"></div></div><div class="card"><div class="section-head"><div><h3>Despesas compartilhadas</h3><div class="muted">Histórico de despesas das quais você participa.</div></div></div><div class="shared-list" id="sharedAllList"></div></div>`;
