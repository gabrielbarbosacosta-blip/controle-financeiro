(function(){
  ...
  function ensureHead(){
    ...
    if(!document.querySelector('meta[name="theme-color"]')){const meta=document.createElement('meta');meta.name='theme-color';meta.content='#0f172a';document.head.appendChild(meta)}
    ...
    if(!document.querySelector('meta[name="apple-mobile-web-app-title"]')){const meta=document.createElement('meta');meta.name='apple-mobile-web-app-title';meta.content='Financeiro';document.head.appendChild(meta)}
  ...
  function ensureInstallUi(){
    ...
    else card.innerHTML='<div class="pwa-install-title">Instalar aplicativo</div><div class="pwa-install-copy">Adicione o Controle Financeiro à tela inicial para abrir como aplicativo.</div><button class="btn small" type="button" id="pwaInstallBtn" disabled>Instalar app</button>';
