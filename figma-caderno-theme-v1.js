(function(){
  ...
  const THEME_VERSION='20260919-navicons1';
  const LABELS={dashboard:'Visão geral',history:'Lançamentos',cards:'Cartões',incomes:'Receitas',debts:'Despesas',projection:'Projeções',goals:'Objetivos',connections:'Conexões',settings:'Configurações'};
  const ICONS={
